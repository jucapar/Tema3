...
<?php
		...
		// Constantes para los valores maximos y minimos de altura, peso y numero de personas encuestadas
		define ("MINALTURA",30);
		...
		$valida = 0;
		//Ruta de subida de las imagenes enviadas
		$directorioSubida = "img/";
		//Array que guardará los datos de los encuestados una vez validados
		$cuestionario = array();
		//Array que guardará los errores producidos durante la validacion de campos
		$erroresCampos = array();
		//Array que activará la clase error para marcar los campos incorrectos en rojo
		$erroresEstilos = array();
		//Array para dejar marcados el campo de sexo elegido una vez validado
		$arraySexo = array();
		//Array para dejar marcadas las aficiones elegidas una vez validadas
		...
		//Si hemos pulsado el boton de Enviar
